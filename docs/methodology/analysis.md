...
::: info
SJAC's primary methodology supports criminal accountability. For missing persons investigations, see [Missing Persons](/methodology/missing-persons).
:::
...
Each Actor will likely have multiple Labels. Primarily [Unverified Labels](/methodology/unverified-labels), with a few [Verified Labels](/methodology/verified-labels) as applicable.
