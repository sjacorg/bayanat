...
def api_notifications():
    ...
    - per_page: number of notifications per page (default: 10, max: 50)
    - status: filter by read status ("read" or "unread", default: all)
    - is_urgent: filter by urgent status (true/false, default: all)
