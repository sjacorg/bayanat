...
BULLETIN_CORE_FIELDS = [
    ...
    ("public_description", "Public Description", "long_text", 6),
    (
        "labels",
        "Labels",
        "select",
    ...
    ("locations", "Locations", "select", 9, {"schema_config": {"allow_multiple": True}}),
    # HTML Blocks - complex components managed through dynamic fields
    ("global_map", "Global Map", "html_block", 10, {"html_template": "global_map"}),
    ("events_section", "Events", "html_block", 11, {"html_template": "events_section"}),
    ("geo_locations", "Geo Locations", "html_block", 12, {"html_template": "geo_locations"}),
    (
        "related_bulletins",
        "Related Bulletins",
        "html_block",
    ...
    ("related_actors", "Related Actors", "html_block", 14, {"html_template": "related_actors"}),
    (
        "related_incidents",
        "Related Incidents",
        "html_block",
    ...
    ("source_link", "Source Link", "text", 16, {"ui_config": {"width": "w-50"}}),
    ("publish_date", "Publish Date", "datetime", 17, {"ui_config": {"width": "w-50"}}),
    (
        "documentation_date",
        "Documentation Date",
        "datetime",
    ...
    ("comments", "Comments", "long_text", 19, {"ui_config": {"width": "w-50"}}),
    (
        "status",
        "Status",
        "select",
