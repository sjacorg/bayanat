...
class ConfigManager:
    ...
    CONFIG_LABELS = MappingProxyType(
        {
            ...
            "LLM_OCR_URL": "LLM OCR Endpoint URL",
            "LLM_OCR_MODEL": "LLM OCR Model",
    ...
    def serialize():
        ...
        conf = {
            ...
            "GOOGLE_VISION_API_KEY": ConfigManager.MASK_STRING if cfg.GOOGLE_VISION_API_KEY else "",
            "LLM_OCR_URL": cfg.LLM_OCR_URL,
            "LLM_OCR_MODEL": cfg.LLM_OCR_MODEL,
