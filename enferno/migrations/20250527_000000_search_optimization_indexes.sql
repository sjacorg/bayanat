...
CREATE INDEX IF NOT EXISTS ix_bulletin_status_assigned 
...
-- Note: CONCURRENTLY removed to allow running inside transaction-based migration runner.
-- IF NOT EXISTS ensures idempotency if indexes already exist.