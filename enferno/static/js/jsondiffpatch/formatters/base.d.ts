...
declare abstract class BaseFormatter<TContext extends BaseFormatterContext, TFormatted = string | undefined> {
    ...
    typeFormattterErrorFormatter(_context: TContext, _err: unknown, _delta: Delta, _leftValue: unknown, _key: string | undefined, _leftKey: string | number | undefined, _movedFrom: MoveDestination | undefined): void;
    finalize({ buffer }: TContext): string;
    ...
    abstract nodeBegin(context: TContext, key: string, leftKey: string | number | undefined, type: DeltaType, nodeType: NodeType, isLast: boolean): void;
    abstract nodeEnd(context: TContext, key: string, leftKey: string | number | undefined, type: DeltaType, nodeType: NodeType, isLast: boolean): void;
