...
declare class AnnotatedFormatter extends BaseFormatter<AnnotatedFormatterContext> {
    ...
    nodeBegin(context: AnnotatedFormatterContext, key: string, _leftKey: string | number, type: DeltaType, nodeType: NodeType): void;
    nodeEnd(context: AnnotatedFormatterContext, _key: string, _leftKey: string | number, type: DeltaType, _nodeType: NodeType, isLast: boolean): void;
