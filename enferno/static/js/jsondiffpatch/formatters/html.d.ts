...
declare class HtmlFormatter extends BaseFormatter<HtmlFormatterContext> {
    ...
    format_unchanged(context: HtmlFormatterContext, _delta: undefined, left: unknown): void;
    format_movedestination(context: HtmlFormatterContext, _delta: undefined, left: unknown): void;
